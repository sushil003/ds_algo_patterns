 ...
 * Height Tree (MHT). There can be multiple MHTs for a graph. In this problem, we need to find all those roots which
 * give us MHTs. Write a method to find all MHTs of the given graph and return a list of their roots.
 * Example 1:
 ...
 * Time complexity : O(V+E)  where ‘V’ is the total nodes and ‘E’ is the total number of the edges.
